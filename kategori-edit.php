...
<body>
	...
	<div class="section">
		<div class="container">
			...
			<div class="box">
				<?php
					$data_view= mysqli_query($conn, "SELECT * FROM kategori WHERE id_kategori = '".$_GET['id_kategori']."' ");
					$row = mysqli_fetch_assoc($data_view);
				?>
				<form method="post" action="">
					<input type="text" name="kategori" class="input-control-2" value="<?php echo $row['nama_kategori']?>" requaired>
					<button type="submit" name="edit" class="edit"> Ubah Kategori</button>
				</form>
...
if (isset($_POST['edit'])) {
	...
	$update = "CALL sp_upktgr('$id', '$kategori')";
